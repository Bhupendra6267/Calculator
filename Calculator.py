...
def show(value):
    global equation
    if value in operator and equation!="":
        if equation[-1] in operator:
            delete()
...
Button(root, text="x",width=5, height=1, font=("arial",30), bd=1, fg="#fff", bg="#2a2d36", command=lambda: show("*")).place(x=290,y=100)
Button(root, text="del",width=5, height=1, font=("arial",30), bd=1, fg="#fff", bg="#2a2d36", command=lambda: delete()).place(x=430,y=100)
...
Button(root, text="=",width=5, height=3, font=("arial",30), bd=1, fg="#fff", bg="#fe9037", command=lambda: calculate()).place(x=430,y=410)
